            ...
            <div class="row">
               <div class="col-md-10 mx-auto">
                  <div class="row text-center">
                     ...
                     <?php 
                        if($contacts = get_field('contact_field','option')){
                        foreach ($contacts as $contact) {
                            ?>
                              <div class="col-md-4">
                                 <div class="contact-address">
                                    <i class="fa <?php echo $contact['icon'];?>"></i>
                                    <h4><?php echo $contact['title'];?> <span><?php echo $contact['subtitle'];?></span></h4>
                                 </div>
                              </div>
                            <?php
                        }
                  ...
                  <div class="row">
                     <div class="col-md-7">
                        ...
                        <?php echo do_shortcode('[contact-form-7 id="269" title="Contact form 1"]')?>
